...
export async function createLocalUiServer(options: LocalUiOptions = {}): Promise<LocalUiServer> {
  ...
  let state: UiState = { status: "idle", url: options.initialUrl ?? null, completed: 0, total: 0, retries: 0, errors: 0, startedAt: null, currentUrl: null, message: "Ready to scan locally.", reportReady: false, summary: null };
