...
export const REPORT_COPY = {
  en: {
    ...
    analytics: {
      ...
      templates: "Affected page templates",
      total: "Total issues",
      noData: "No issues to chart.",
      filterBy: "Filter by",
    },
    history: { title: "Local scan history", hint: "Issue trends from snapshots stored on this device.", chartLabel: "Issue trend across runs.", runs: "Runs", pages: "Latest pages", newIssues: "New issues", resolvedIssues: "Resolved issues", sitemapUrls: "Sitemap URLs", maxDepth: "Maximum crawl depth" },
    tabs: { current: "Current / all", new: "New", ongoing: "Ongoing", resolved: "Resolved", unchanged: "Unchanged" },
    filters: { search: "URL or text", searchPlaceholder: "URL, check, or message", severity: "Severity", rule: "Check", template: "Page template", owner: "Owner", rows: "Rows" },
    all: { severity: "All severities", rule: "All checks", template: "All templates", owner: "All owners" },
  ...
  uk: {
    ...
    analytics: {
      ...
      lifecycle: "За станом",
      templates: "Шаблони сторінок із проблемами",
      total: "Усього проблем",
      noData: "Немає проблем для відображення.",
      filterBy: "Фільтрувати за",
    },
    history: { title: "Локальна історія сканувань", hint: "Динаміка проблем зі snapshot-файлів, збережених на цьому пристрої.", chartLabel: "Динаміка проблем за запусками.", runs: "Запуски", pages: "Сторінок востаннє", newIssues: "Нові проблеми", resolvedIssues: "Виправлені проблеми", sitemapUrls: "URL у sitemap", maxDepth: "Максимальна глибина" },
    tabs: { current: "Поточні / усі", new: "Нові", ongoing: "Тривають", resolved: "Виправлені", unchanged: "Без змін" },
    filters: { search: "URL або текст", searchPlaceholder: "URL, перевірка або повідомлення", severity: "Важливість", rule: "Перевірка", template: "Шаблон сторінки", owner: "Відповідальний", rows: "Рядки" },
    all: { severity: "Усі рівні", rule: "Усі перевірки", template: "Усі шаблони", owner: "Усі відповідальні" },
